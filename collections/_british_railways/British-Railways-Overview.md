...
With this kind of experience, I've got many tips and tricks to share. In this chapter, we'll begin with a practical overview of the British railway system in general. Then we will [untangle the lore of tickets]({{ site.url }}/{{ page.collection }}/Understanding-Train-Tickets) and [discounts]({{ site.url }}/{{ page.collection }}/Railcards-and-Other-Discounts) - this knowledge will be your money saver. Next come the how-to's for [journey planning]({{ site.url }}/{{ page.collection }}/Planning-a-Journey) - you'll learn how to save even more. Finally, we'll be going for a ride, and there are a few catches you might want to know as well.
...
![Marylebone station sign]({{ site.url }}/images/{{ page.collection }}/Marylebone_Station_British_Rail_and_Underground_2.jpg)
...
![West Midlands First Class interior]({{ site.url }}/images/{{ page.collection }}/west_midlands_First_Class_Interior.JPG)
